...
#define in_bt_start_Pin GPIO_PIN_0
#define in_bt_start_GPIO_Port GPIOA
#define in_bt_stop_Pin GPIO_PIN_1
#define in_bt_stop_GPIO_Port GPIOA
#define out_sw_psu_dcout_Pin GPIO_PIN_4
#define out_sw_psu_dcout_GPIO_Port GPIOA
#define out_sw_psu_acin_Pin GPIO_PIN_5
#define out_sw_psu_acin_GPIO_Port GPIOA
#define in_bt_emergency_Pin GPIO_PIN_6
